...
//IO操作函数	 
#define FT_RST(n)   (n?HAL_GPIO_WritePin(FT6336_RES_GPIO_Port,FT6336_RES_Pin,GPIO_PIN_SET):HAL_GPIO_WritePin(FT6336_RES_GPIO_Port,FT6336_RES_Pin,GPIO_PIN_RESET))	//FT6336复位引脚
// #define FT_INT    	HAL_GPIO_ReadPin(GPIOH,GPIO_PIN_11) 		//FT6336中断引脚	

#define FT6336_ADDR        0x38    // 7位设备地址

//I2C读写命令	
#define FT6336_ADDR_WRITE      0x70    // 8位写地址（0x38<<1 | 0）
#define FT6336_ADDR_READ       0x71    // 8位读地址（0x38<<1 | 1）

...
>>>>>>> 549c90100fe6ee3058708b41819c73bc52cf9fa8
  ...
  while (1)
  {
		...
		if(cur - led0_start_time >= led0_add)
		{
			led0_start_time = cur;
			HAL_GPIO_TogglePin(LED0_GPIO_Port,LED0_Pin);
		}
		
		uint8_t key0_read_now = HAL_GPIO_ReadPin(KEY0_GPIO_Port,KEY0_Pin);
		
		if((key0_read_now == 0)&&(key0_read_last == 1)&&(led0_add<=2000))
		{ 	
    ...
    /* USER CODE END WHILE */
		key0_read_last = key0_read_now;//将现在的电平状态替换成下一次要用的
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
}

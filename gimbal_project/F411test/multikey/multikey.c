...
#define KEY_DEBOUNCE_TIME 10           // 消抖时间，单位与 MULTIKEY_GET_TICK 一致
#define KEY_LONGPRESS_TIME 500         // 长按判定时间，单位与 MULTIKEY_GET_TICK 一致
#define KEY_LONGPRESS_REPEAT_TIME 100  // 长按重复触发间隔，单位与 MULTIKEY_GET_TICK 一致
